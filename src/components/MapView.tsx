...
const canteenIcon = L.divIcon({
  className: 'custom-canteen-icon',
  html: `
    <svg width="30" height="42" viewBox="0 0 30 42" fill="none" xmlns="http://www.w3.org/2000/svg" style="transform: translate(-15px, -42px);">
  ...
  `,
  iconSize: [30, 42],
  iconAnchor: [0, 0], // ใช้การทำ translate ใน SVG แทนเพื่อความแน่นอน
  popupAnchor: [0, -42]
});
